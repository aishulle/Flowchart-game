...
const expectedFlow = [
  ...
  ['Convert Format', 'Splitting and Chunking'],
  ['Splitting and Chunking', 'Vector DB'],
  ['Splitting and Chunking', 'Embedding Model'],
...
function FlowchartGame({ question, onBack }: FlowchartGameProps) {
  ...
  const handleShowSolution = () => {
    ...
    const nodePositions: Record<string, { x: number; y: number }> = {
      ...
      'Splitting and Chunking': { x: 400, y: 580 },
...
export default function Flowchart1Page({ question, onBack }: FlowchartGameProps) {
  return (
    <ReactFlowProvider>
      <FlowchartGame question={question} onBack={onBack} />
    </ReactFlowProvider>
  );
}
